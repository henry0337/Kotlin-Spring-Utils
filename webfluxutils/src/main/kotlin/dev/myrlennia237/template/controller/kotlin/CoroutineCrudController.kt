 ...
 */
@KotlinVariant
abstract class CoroutineCrudController<T : Any, in ID, in I1, in I2> : BaseReactiveController() {
     ...
     */
    abstract suspend fun update(id: ID, body: I2): T
     ...
     */
    @ResponseStatus(HttpStatus.NO_CONTENT)
    abstract suspend fun disable(id: ID)
     ...
     */
    @ResponseStatus(HttpStatus.NO_CONTENT)
    abstract suspend fun enable(id: ID)
}
