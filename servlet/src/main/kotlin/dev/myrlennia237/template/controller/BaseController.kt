...
/**
 * Một lớp wrapper [Controller][org.springframework.web.bind.annotation.RestController] chứa **dependency** có thể
 * hữu ích trong khi triển khai logic nghiệp vụ cho các lớp kế thừa lớp này.
 *
